...
# 数据 root 目录
parser.add_argument('--root_path', default='', type=str, help='path to root path of images')
# 训练数据集 list
parser.add_argument('--train_list', default='~/dataset/CASIA-WebFace/CASIA-WebFace-112X96.txt', type=str, help='path to training list')
# batch-size default=512
parser.add_argument('--batch-size', type=int, default=512, metavar='N', help='input batch size for training (default: 512)')
# 模型 class 的数目-10572
parser.add_argument('--num_class', default=10572, type=int, help='number of people(class) (default: 10572)')
# LR policy
# 训练的 epoch
...
# 保存 checkpoint 的路径
parser.add_argument('--save_path', default='checkpoint/', type=str, metavar='PATH', help='path to save checkpoint')
